...
// Set buttons for algorithm turn speed
    ...
    sf::Text buttonAlgorithm1Text("Algorithm 1", font, 15);
    ...
    sf::Text buttonAlgorithm2Text("Algorithm 2", font, 15);
                ...
                if (event.mouseButton.button == sf::Mouse::Left) {
                    ...
                    if (maxRotateText.getGlobalBounds().contains(clickPos)) {
                        ...
                        std::cout << numSolves << " solves with beginners method completed. Success rate = "
                                  ...
                                  << successRate << "% Average Number of Moves = " << averageRotations << std::endl;
                        successes = 0;
                        averageRotations = 0;
                        fails = 0;
                        numSolves = 100000;
